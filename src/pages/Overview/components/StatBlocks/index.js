...
const StatBlocks = () => {
  ...
  const getDarkModeBgColor = (lightColor) => {
    const colorMap = {
      "#E3F5FF": "rgba(255, 255, 255, 0.05)",
      "#F7F9FB": "rgba(255, 255, 255, 0.05)",
      "#E5ECF6": "rgba(255, 255, 255, 0.05)",
    };
    return colorMap[lightColor] || "rgba(255, 255, 255, 0.05)";
  };

  return (
    <div className={`stats-block ${isDarkMode ? "dark" : "light"}`}>
        ...
        <div
          ...
          style={{
            backgroundColor: isDarkMode
              ? getDarkModeBgColor(stat.bgColor)
              : stat.bgColor,
          }}
        >
